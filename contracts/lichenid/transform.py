#!/usr/bin/env python3
"""
Transform all from_raw_parts in lichenid/src/lib.rs to owned-copy pattern.
...
SLICE_FNS = [
    ...
    'vouch_cooldown_key', 'register_cooldown_key', 'validate_licn_name',
...
for i, line in enumerate(new_lines):
    ...
    for var_name, vtype in cur_vars.items():
        ...
        # Fix lichen_sdk::set_return_data
        if 'lichen_sdk::set_return_data' in modified:
            modified = add_ref_to_fn_arg(modified, 'lichen_sdk::set_return_data', var_name)
