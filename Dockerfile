...
COPY faucet/Cargo.toml faucet/Cargo.toml
COPY custody/Cargo.toml custody/Cargo.toml

# Create dummy source files for dependency caching
RUN mkdir -p core/src validator/src rpc/src cli/src p2p/src faucet/src custody/src && \
    echo "fn main() {}" > validator/src/main.rs && \
    echo "fn main() {}" > cli/src/main.rs && \
    echo "fn main() {}" > faucet/src/main.rs && \
