...
const SEARCH_INDEX = [
    ...
    // JSON-RPC API
    { title: 'JSON-RPC API Reference', desc: 'Complete list of all RPC endpoints', url: 'api/json-rpc.html', category: 'API' },
    { title: 'molt_getBalance', desc: 'Get account balance by address', url: 'api/json-rpc.html#getBalance', category: 'API' },
    { title: 'molt_getBlock', desc: 'Retrieve a block by number or hash', url: 'api/json-rpc.html#getBlock', category: 'API' },
    { title: 'molt_sendTransaction', desc: 'Submit a signed transaction', url: 'api/json-rpc.html#sendTransaction', category: 'API' },
    { title: 'molt_getTransactionReceipt', desc: 'Get transaction receipt by hash', url: 'api/json-rpc.html#getTransactionReceipt', category: 'API' },
    { title: 'molt_call', desc: 'Execute a read-only smart contract call', url: 'api/json-rpc.html#call', category: 'API' },
    { title: 'molt_estimateGas', desc: 'Estimate gas for a transaction', url: 'api/json-rpc.html#estimateGas', category: 'API' },
    { title: 'molt_subscribe', desc: 'Subscribe to real-time events via WebSocket', url: 'api/json-rpc.html#subscribe', category: 'API' },
    { title: 'molt_getCode', desc: 'Get contract bytecode at an address', url: 'api/json-rpc.html#getCode', category: 'API' },
    { title: 'molt_getLogs', desc: 'Query event logs with filters', url: 'api/json-rpc.html#getLogs', category: 'API' },

    // SDK
    { title: 'JavaScript SDK', desc: 'Client library for Node.js and browsers', url: 'sdk/javascript.html', category: 'SDK' },
    ...
    { title: 'Creating a Wallet', desc: 'Generate and manage keypairs', url: 'sdk/javascript.html#wallets', category: 'SDK' },
    { title: 'Sending Transactions', desc: 'Build, sign, and send transactions', url: 'sdk/javascript.html#transactions', category: 'SDK' },
    { title: 'Querying Balances', desc: 'Check token and MOLT balances', url: 'sdk/javascript.html#balances', category: 'SDK' },

    // Smart Contracts
    { title: 'Smart Contracts Overview', desc: 'Writing and deploying contracts on MoltChain', url: 'contracts/overview.html', category: 'Contracts' },
    { title: 'Contract Development', desc: 'Tools and patterns for contract development', url: 'contracts/development.html', category: 'Contracts' },
    { title: 'Deploying Contracts', desc: 'Deploy smart contracts to MoltChain networks', url: 'contracts/deploy.html', category: 'Contracts' },
    { title: 'Contract Events', desc: 'Emitting and listening for events', url: 'contracts/events.html', category: 'Contracts' },
    { title: 'MoltPunks NFT Contract', desc: 'Reference implementation of NFT standard', url: 'contracts/moltpunks.html', category: 'Contracts' },
    { title: 'MoltOracle Contract', desc: 'On-chain oracle for price feeds', url: 'contracts/moltoracle.html', category: 'Contracts' },
    ...
    // Tokens
    { title: 'Token Standard (MRC-20)', desc: 'Fungible token standard specification', url: 'tokens/mrc20.html', category: 'Tokens' },
    { title: 'NFT Standard (MRC-721)', desc: 'Non-fungible token standard', url: 'tokens/mrc721.html', category: 'Tokens' },
    { title: 'Creating a Token', desc: 'Step-by-step token creation guide', url: 'tokens/create.html', category: 'Tutorial' },

    // Validators
    { title: 'Running a Validator', desc: 'Set up and operate a validator node', url: 'validators/setup.html', category: 'Validators' },
    { title: 'Staking Guide', desc: 'Stake MOLT and earn rewards', url: 'validators/staking.html', category: 'Validators' },
    { title: 'Validator Requirements', desc: 'Hardware and network requirements', url: 'validators/requirements.html', category: 'Validators' },

    // Tools
    { title: 'Block Explorer', desc: 'Browse blocks, transactions, and accounts', url: '../explorer/index.html', category: 'Tools' },
    { title: 'Faucet', desc: 'Get testnet MOLT tokens', url: 'tools/faucet.html', category: 'Tools' },
