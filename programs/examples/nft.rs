...
/// Get token metadata
#[no_mangle]
pub extern "C" fn get_punk_metadata(token_id: u64) -> Result<NFTMetadata, String> {
...
#[no_mangle]
pub extern "C" fn get_collection_stats() -> Result<NFTState, String> {
...
#[no_mangle]
pub extern "C" fn total_minted() -> Result<u64, String> {
    let state = get_storage::<NFTState>(b"nft_state")?
        .ok_or("NFT not initialized")?;
    Ok(state.next_token_id - 1)
}
