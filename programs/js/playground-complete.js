...
const Playground = {
    ...
    async initNetwork(network) {
        ...
        this.rpc = new MoltChain.RPC(network);
        this.ws = new MoltChain.WebSocket(network);
    ...
    async updateRegistryStatus() {
        ...
        try {
            ...
            this.setRegistryStatus('Registry check failed', 'warning');
        }
    },
...
`;
    ...
    async switchNetwork(network) {
        this.addTerminalLine(`🔄 Switching to ${network}...`, 'info');
        ...
        await this.initNetwork(network);
        ...
        this.addTerminalLine(`✅ Switched to ${network}`, 'success');
    },
    ...
    updateNetworkDisplay() {
        ...
        if (faucetBtn) {
            faucetBtn.style.display = this.network === 'mainnet' ? 'none' : 'inline-flex';
        }
