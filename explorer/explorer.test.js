...
// From address.js — trust tier labels (canonical for identity)
...
{
    // All three tier functions must return the same results for same inputs
    const testScores = [0, 50, 100, 150, 200, 300, 400, 500, 600, 700, 800, 900, 950, 1000];
    ...
    assertEqual(getTrustTierLabel(0), 'Probation', 'F13.5c — score 0 = Probation');
    assertEqual(getTrustTierLabel(99), 'Probation', 'F13.5d — score 99 = Probation');
    assertEqual(getTrustTierLabel(100), 'Newcomer', 'F13.5e — score 100 = Newcomer');
    assertEqual(getTrustTierLabel(199), 'Newcomer', 'F13.5f — score 199 = Newcomer');
    assertEqual(getTrustTierLabel(200), 'Verified', 'F13.5g — score 200 = Verified');
    assertEqual(getTrustTierLabel(399), 'Verified', 'F13.5h — score 399 = Verified');
    assertEqual(getTrustTierLabel(400), 'Trusted', 'F13.5i — score 400 = Trusted');
    assertEqual(getTrustTierLabel(599), 'Trusted', 'F13.5j — score 599 = Trusted');
    assertEqual(getTrustTierLabel(600), 'Established', 'F13.5k — score 600 = Established');
    assertEqual(getTrustTierLabel(799), 'Established', 'F13.5l — score 799 = Established');
    assertEqual(getTrustTierLabel(800), 'Elite', 'F13.5m — score 800 = Elite');
    assertEqual(getTrustTierLabel(949), 'Elite', 'F13.5n — score 949 = Elite');
    assertEqual(getTrustTierLabel(950), 'Legendary', 'F13.5o — score 950 = Legendary');
