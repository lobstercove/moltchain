...
### Foundation
Core vision, economics, and project overview:
- [VISION.md](foundation/VISION.md) - The manifesto for agent economic independence
...
- [ARCHITECTURE.md](ARCHITECTURE.md) - Deep dive into the protocol
- [PROJECT_STRUCTURE.md](architecture/PROJECT_STRUCTURE.md) - Code organization
- [BUILD_SPEC.md](architecture/BUILD_SPEC.md) - Build and development guide
- [AI_AGENT_SKILLS.md](architecture/AI_AGENT_SKILLS.md) - Agent integration patterns
...
- [JAVASCRIPT_SDK.md](api/JAVASCRIPT_SDK.md) - JavaScript/TypeScript SDK
- [PYTHON_SDK.md](api/PYTHON_SDK.md) - Python SDK
- [RUST_SDK.md](api/RUST_SDK.md) - Rust SDK

### Consensus & Staking
Proof of Contribution and validator economics:
...
**For Validators:**
1. [VALIDATOR_SETUP.md](consensus/VALIDATOR_SETUP.md) - Setup guide
2. [CONTRIBUTORY_STAKE_GUIDE.md](../skills/validator/CONTRIBUTORY_STAKE_GUIDE.md) - Zero-capital staking
3. [ADAPTIVE_HEARTBEAT.md](consensus/ADAPTIVE_HEARTBEAT.md) - Reward system

**For Developers:**
1. [CONTRACT_DEVELOPMENT_GUIDE.md](guides/CONTRACT_DEVELOPMENT_GUIDE.md) - Build smart contracts
2. [RPC_API_REFERENCE.md](guides/RPC_API_REFERENCE.md) - API reference
3. [SDK Documentation](api/) - Choose your language
