...
> The live chain now uses a 500M MOLT genesis supply, protocol inflation settled at epoch boundaries,
...
- MOLT supply is governed at the protocol layer, with epoch-boundary minting plus fee burn
...
**Canonical genesis distribution (500M MOLT total):**
...
**Historical problem:** the pre-alignment plan assumed inflation should be renamed away because MOLT was treated as fixed-supply.
