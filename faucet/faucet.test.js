...
// From faucet.js — escapeHtml (F16.1 fix)
...
if (fs.existsSync(faucetPath)) {
    ...
    assert(src.includes('function escapeHtml(str)'),
        'faucet.js: escapeHtml helper exists');
    ...
    assert(src.includes('encodeURIComponent(data.amount)'),
