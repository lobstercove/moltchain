(() => {
  ...
  function scheduleProviderStateRefresh(delayMs = 50) {
  ...
  async function startProviderMonitor() {
    ...
    document.addEventListener('visibilitychange', () => {
      if (document.visibilityState === 'visible') scheduleProviderStateRefresh(0);
    });
    window.addEventListener('focus', () => scheduleProviderStateRefresh(0));
  }
