...
class MoltCrypto {
    ...
    static async decryptKeypair(encryptedData, password) {
        ...
        return {
            seed: seed,
            privateKey: seedHex,                               // 64 hex chars — consistent with mnemonicToKeypair()
    ...
    static async signTransaction(privateKeyHex, messageBytes) {
        ...
        // Note: in JavaScript this is best-effort only because engines/GC may
        // retain internal copies we cannot explicitly wipe.
        seed.fill(0);
